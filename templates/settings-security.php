...
?>
<div class="wrap">
    <h1><?php esc_html_e( 'Security Settings', 'kp-file-manager' ); ?></h1>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table" role="presentation">
            ...
            <tr>
                <th scope="row"><label for="kfm_blocked_exts"><?php esc_html_e( 'Blocked Upload Extensions', 'kp-file-manager' ); ?></label></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'Comma-separated list of extensions that cannot be uploaded. Lowercase, no dots. MIME type is also verified server-side regardless of this list.', 'kp-file-manager' ); ?></p>
                    <p><button type="button" class="button button-small" id="kfm-reset-blocked">
                        <?php esc_html_e( 'Reset to defaults', 'kp-file-manager' ); ?>
                    </button></p>
                </td>
            </tr>
            ...
            <tr>
                <th scope="row"><label for="kfm_readonly_exts"><?php esc_html_e( 'Read-only Extensions', 'kp-file-manager' ); ?></label></th>
                <td>
                    <input type="text"
                    ...
                    <p class="description"><?php esc_html_e( 'Comma-separated extensions that can be viewed but not edited or saved. Leave blank to allow editing all types.', 'kp-file-manager' ); ?></p>
                </td>
            </tr>

            <!-- Path Denylist -->
            <tr>
                <th scope="row"><label for="kfm_path_denylist"><?php esc_html_e( 'Hidden / Blocked Paths', 'kp-file-manager' ); ?></label></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'One entry per line, relative to the base directory. Matching paths and all their contents are hidden and inaccessible to all users including admins.', 'kp-file-manager' ); ?></p>
                </td>
            </tr>

            <!-- Chmod Floor -->
            <tr>
                <th scope="row"><label for="kfm_chmod_floor"><?php esc_html_e( 'Minimum Permissions Floor', 'kp-file-manager' ); ?></label></th>
                <td>
                    <input type="text"
            ...
            <!-- Email Alerts -->
            <tr>
                <th scope="row"><?php esc_html_e( 'Destructive Operation Alerts', 'kp-file-manager' ); ?></th>
                <td>
                    <label>
                        <input type="checkbox"
            ...
            <tr>
                <th scope="row"><label for="kfm_alert_emails"><?php esc_html_e( 'Alert Email Address(es)', 'kp-file-manager' ); ?></label></th>
                <td>
                    <input type="text"
    ...
    <div style="background:#f8f9fa;border:1px solid #e2e8f0;border-radius:4px;padding:14px 18px;max-width:800px">
        <h3 style="margin-top:0;font-size:14px"><?php esc_html_e( 'Security measures always active', 'kp-file-manager' ); ?></h3>
        <ul style="margin:0;font-size:13px">
            <li><?php esc_html_e( 'All paths verified against sandbox via realpath() — no path traversal possible.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'Every AJAX request requires a valid WordPress nonce and matching referer origin.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'Upload MIME type verified server-side via finfo regardless of extension.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'PHP content is rejected on upload regardless of file extension.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'Write operations are rate-limited to 60 per minute per user.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'World-writable permissions (o+w) are always blocked.', 'kp-file-manager' ); ?></li>
            <li><?php esc_html_e( 'All write/delete/chmod operations are logged to the Audit Log.', 'kp-file-manager' ); ?></li>
        </ul>
    </div>
</div>
