...
<div id="kfm-wrap" class="kfm-wrap">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-wrap kfm-toolbar-left">
            ...
            <div class="uk-button-group kfm-btn-group">
                <button class="uk-button uk-button-default uk-button-small kfm-needs-sel" id="kfm-btn-rename" disabled>
                    <span uk-icon="icon: tag; ratio: 0.85"></span> Rename
                </button>
                <button class="uk-button uk-button-default uk-button-small kfm-needs-sel" id="kfm-btn-chmod" disabled>
                    <span uk-icon="icon: lock; ratio: 0.85"></span> Permissions
                </button>
            </div>

            <button class="uk-button uk-button-danger uk-button-small kfm-btn-sep kfm-needs-sel" id="kfm-btn-delete" disabled>
                <span uk-icon="icon: trash; ratio: 0.85"></span> Delete
            </button>
        </div>

        <div class="uk-flex uk-flex-middle kfm-toolbar-right">
            <span class="kfm-status" id="kfm-status"></span>
            <button class="uk-button uk-button-default uk-button-small kfm-theme-btn" id="kfm-btn-theme" title="Toggle dark / light mode">
                <span id="kfm-theme-icon" aria-hidden="true">&#x1F319;</span>
            </button>
            <button class="uk-button uk-button-default uk-button-small" id="kfm-btn-refresh" uk-tooltip="Refresh">
        ...
        <main class="kfm-main" id="kfm-main">
            <div class="uk-overflow-auto kfm-table-scroll">
                <table class="uk-table uk-table-small uk-table-hover uk-table-divider kfm-table" id="kfm-table">
                    <thead>
                        <tr>
                            <th class="kfm-col-check"><input class="uk-checkbox" type="checkbox" id="kfm-check-all" title="Select all"></th>
                            <th class="kfm-col-icon"></th>
                            <th class="kfm-col-name kfm-sortable" data-sort="name">Name <span class="kfm-sort-arrow">&#x25B2;</span></th>
                            <th class="kfm-col-size kfm-sortable" data-sort="size">Size</th>
                            <th class="kfm-col-perms kfm-sortable" data-sort="perms">Perms</th>
                            <th class="kfm-col-mtime kfm-sortable" data-sort="mtime">Modified</th>
                            <th class="kfm-col-actions">Actions</th>
                        </tr>
                    </thead>
            ...
            <div class="kfm-empty uk-text-center uk-padding" id="kfm-empty" style="display:none">
                ...
                <p class="uk-text-muted uk-margin-small-top">This folder is empty.</p>
            </div>
        </main>
    </div>
    ...
    <div class="kfm-dropzone" id="kfm-dropzone">
        ...
        <p class="uk-margin-small-top">Drop files here to upload</p>
    </div>
...
<div id="kfm-modal-generic" uk-modal="bg-close: false; esc-close: true">
    <div class="uk-modal-dialog uk-margin-auto-vertical">
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <button class="uk-button uk-button-primary uk-button-small" type="button" id="kfm-modal-ok">OK</button>
        </div>
    </div>
</div>
...
<div id="kfm-editor-modal" uk-modal="bg-close: false; esc-close: true">
    <div class="uk-modal-dialog uk-modal-full kfm-editor-dialog">
        <div class="kfm-editor-header uk-flex uk-flex-between uk-flex-middle">
            <h3 class="uk-h5 uk-margin-remove" id="kfm-editor-title">Edit File</h3>
            <div class="uk-flex uk-flex-middle kfm-editor-header-actions">
                <button class="uk-button uk-button-primary uk-button-small" id="kfm-editor-save" type="button">
                    <span uk-icon="icon: check; ratio: 0.85"></span> Save
                </button>
        ...
        <div class="kfm-editor-statusbar">
            <span id="kfm-editor-cursor">Ln 1, Col 1</span>
...
<div id="kfm-chmod-modal" uk-modal="bg-close: false; esc-close: true">
    <div class="uk-modal-dialog uk-margin-auto-vertical" style="max-width:380px">
        <button class="uk-modal-close-default" type="button" uk-close></button>
        <div class="uk-modal-header">
            <h3 class="uk-modal-title uk-h5">Change Permissions</h3>
        </div>
        <div class="uk-modal-body">
            ...
            <table class="uk-table uk-table-small uk-table-divider kfm-chmod-table">
                <thead>
                    <tr>
                        <th></th>
                        <th class="uk-text-center">Read</th>
                        <th class="uk-text-center">Write</th>
                        <th class="uk-text-center">Execute</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="uk-text-bold">Owner</td>
                    ...
                    <tr>
                        <td class="uk-text-bold">Other</td>
            ...
            <div class="uk-flex uk-flex-middle uk-margin-small-top" style="gap:8px">
                <label class="uk-form-label uk-margin-remove" for="kfm-chmod-octal">Octal:</label>
        ...
        <div class="uk-modal-footer uk-text-right">
            <button class="uk-button uk-button-default uk-button-small uk-modal-close" type="button">Cancel</button>
            <button class="uk-button uk-button-primary uk-button-small" type="button" id="kfm-chmod-apply">Apply</button>
        </div>
    </div>
</div>
