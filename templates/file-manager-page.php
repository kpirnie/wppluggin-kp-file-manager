...
<div id="kfm-wrap" class="kfm-wrap">
        ...
        <div class="kfm-toolbar-left">
            ...
            <div class="kfm-btn-group">
                <button class="kfm-btn kfm-btn-primary kfm-btn-sm" id="kfm-btn-new-file">
                    <span class="dashicons dashicons-edit"></span><?php _e( 'New File', 'kpfm' ); ?>
                </button>
                <button class="kfm-btn kfm-btn-primary kfm-btn-sm" id="kfm-btn-new-folder">
                    <span class="dashicons dashicons-portfolio"></span><?php _e( 'New Folder', 'kpfm' ); ?>
                </button>
            </div>

            <button class="kfm-btn kfm-btn-sm kfm-btn-sep" id="kfm-btn-upload">
                <span class="dashicons dashicons-upload"></span><?php _e( 'Upload', 'kpfm' ); ?>
            </button>
            ...
            <div class="kfm-btn-group">
                <button class="kfm-btn kfm-btn-sm kfm-needs-sel" id="kfm-btn-copy" disabled>
                    <span class="dashicons dashicons-admin-page"></span><?php _e( 'Copy', 'kpfm' ); ?>
                </button>
                ...
                <button class="kfm-btn kfm-btn-sm" id="kfm-btn-paste" disabled>
                    <span class="dashicons dashicons-migrate"></span><?php _e( 'Paste', 'kpfm' ); ?>
                </button>
            </div>
            ...
            <div class="kfm-btn-group">
                <button class="kfm-btn kfm-btn-sm kfm-needs-sel" id="kfm-btn-rename" disabled>
                    <span class="dashicons dashicons-tag"></span><?php _e( 'Rename', 'kpfm' ); ?>
                </button>
                <button class="kfm-btn kfm-btn-sm kfm-needs-sel" id="kfm-btn-chmod" disabled>
                    <span class="dashicons dashicons-lock"></span><?php _e( 'Permissions', 'kpfm' ); ?>
                </button>
            </div>

            <button class="kfm-btn kfm-btn-danger kfm-btn-sm kfm-btn-sep kfm-needs-sel" id="kfm-btn-delete" disabled>
                <span class="dashicons dashicons-trash"></span><?php _e( 'Delete', 'kpfm' ); ?>
            </button>
        </div>

        <div class="kfm-toolbar-right">
            <span class="kfm-status" id="kfm-status"></span>
            <button class="kfm-btn kfm-btn-sm kfm-theme-btn" id="kfm-btn-theme" title="<?php esc_attr_e( 'Toggle dark / light mode', 'kpfm' ); ?>">
                <span id="kfm-theme-icon" aria-hidden="true">&#x1F319;</span>
            </button>
            <button class="kfm-btn kfm-btn-sm" id="kfm-btn-refresh" title="<?php esc_attr_e( 'Refresh', 'kpfm' ); ?>">
        ...
        <main class="kfm-main" id="kfm-main">
            <div class="kfm-table-scroll">
                <table class="kfm-table" id="kfm-table">
                    <thead>
                        <tr>
                            <th class="kfm-col-check"><input type="checkbox" id="kfm-check-all" title="<?php esc_attr_e( 'Select all', 'kpfm' ); ?>"></th>
            ...
            <div class="kfm-empty" id="kfm-empty" style="display:none">
                ...
                <p><?php _e( 'This folder is empty.', 'kpfm' ); ?></p>
            </div>
        </main>
    </div>
    ...
    <div class="kfm-dropzone" id="kfm-dropzone">
        ...
        <p><?php _e( 'Drop files here to upload', 'kpfm' ); ?></p>
    </div>
...
<div id="kfm-modal-generic" class="kfm-modal" data-bg-close="false">
    <div class="kfm-modal-dialog">
        ...
        <div class="kfm-modal-footer">
            <button class="kfm-btn kfm-btn-sm" type="button" data-kfm-modal-close><?php _e( 'Cancel', 'kpfm' ); ?></button>
            <button class="kfm-btn kfm-btn-primary kfm-btn-sm" type="button" id="kfm-modal-ok"><?php _e( 'OK', 'kpfm' ); ?></button>
        </div>
    </div>
</div>
...
<div id="kfm-editor-modal" class="kfm-modal kfm-modal-full" data-bg-close="false">
    <div class="kfm-modal-dialog kfm-editor-dialog">
        <div class="kfm-editor-header">
            <h3 class="kfm-editor-title" id="kfm-editor-title"><?php _e( 'Edit File', 'kpfm' ); ?></h3>
            <div class="kfm-editor-header-actions">
                <button class="kfm-btn kfm-btn-primary kfm-btn-sm" id="kfm-editor-save" type="button">
                    <span class="dashicons dashicons-yes"></span><?php _e( 'Save', 'kpfm' ); ?>
                </button>
...
<div id="kfm-chmod-modal" class="kfm-modal" data-bg-close="false">
    <div class="kfm-modal-dialog" style="max-width:380px">
        <div class="kfm-modal-header">
            <h3 class="kfm-modal-title"><?php _e( 'Change Permissions', 'kpfm' ); ?></h3>
            <button class="kfm-modal-close-btn" type="button" data-kfm-modal-close>
                <span class="dashicons dashicons-no-alt"></span>
            </button>
        </div>
        <div class="kfm-modal-body">
            ...
            <table class="kfm-chmod-table">
                <thead>
                    <tr>
                        <th></th>
                        <th><?php _e( 'Read', 'kpfm' ); ?></th>
                        <th><?php _e( 'Write', 'kpfm' ); ?></th>
                        <th><?php _e( 'Execute', 'kpfm' ); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><?php _e( 'Owner', 'kpfm' ); ?></td>
            ...
            <div class="kfm-chmod-octal-row">
                <label class="kfm-form-label" for="kfm-chmod-octal"><?php _e( 'Octal', 'kpfm' ); ?>:</label>
        ...
        <div class="kfm-modal-footer">
            <button class="kfm-btn kfm-btn-sm" type="button" data-kfm-modal-close><?php _e( 'Cancel', 'kpfm' ); ?></button>
            <button class="kfm-btn kfm-btn-primary kfm-btn-sm" type="button" id="kfm-chmod-apply"><?php _e( 'Apply', 'kpfm' ); ?></button>
        </div>
    </div>
</div>
